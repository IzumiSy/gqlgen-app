...
func (tq *TodoQuery) QueryAssignee() *UserQuery {
...
func (tq *TodoQuery) WithAssignee(opts ...func(*UserQuery)) *TodoQuery {
	query := &UserQuery{config: tq.config}
...
func (tq *TodoQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Todo, error) {
	...
	if query := tq.withAssignee; query != nil {
		if err := tq.loadAssignee(ctx, query, nodes, nil,
			func(n *Todo, e *User) { n.Edges.Assignee = e }); err != nil {
			return nil, err
		}
	}
...
func (tq *TodoQuery) loadAssignee(ctx context.Context, query *UserQuery, nodes []*Todo, init func(*Todo), assign func(*Todo, *User)) error {
