...
func (cq *CategoryQuery) loadTodos(ctx context.Context, query *TodoQuery, nodes []*Category, init func(*Category), assign func(*Category, *Todo)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(category.TodosTable)
		s.Join(joinT).On(s.C(todo.FieldID), joinT.C(category.TodosPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(category.TodosPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(category.TodosPrimaryKey[0]))
